 ...
 * 
 *  Matrix containing 40 reference/measurement vectors of size 12 for first 40 nodes.
 */
real_t y[ 480 ];
...
/** Matrix of size: 520 x 6 (row major format) */
real_t evGu[ 3120 ];
...
/** Matrix of size: 520 x 12 (row major format) */
real_t Q2[ 6240 ];
...
/** Matrix of size: 10660 x 6 (row major format) */
real_t E[ 63960 ];
