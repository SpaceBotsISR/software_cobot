...
//    }
    ...
    gcs_chan[chan-MAVLINK_COMM_0].send_heartbeat(MAV_TYPE_HEXAROTOR,
...
//#endif
    ...
    case MAVLINK_MSG_ID_PARAM_REQUEST_LIST:         // MAV ID: 21
    {
        ...
        GCS_MAVLINK::send_statustext_chan(MAV_SEVERITY_INFO, chan, "Frame: %s", "SPACE_COBOT");
...
//#endif
    ...
    case MAVLINK_MSG_ID_COMMAND_LONG:       // MAV ID: 76
    {
        ...
        //TODO: May be useful in the future to allow preflight calib via ROS
...
/// (FILIPE ROSA) Commented line which run cli
/*
