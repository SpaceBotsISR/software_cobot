...
#ifndef ARDUPILOT_AC_ATTITUDECONTROL_SCOBOT_H
#define ARDUPILOT_AC_ATTITUDECONTROL_SCOBOT_H
 ...
 * @return
 */
Eigen::Vector3d attitudeController(Eigen::RowVector4d q_current, Eigen::RowVector4d q_des, Eigen::Vector3d omega_current, Eigen::Vector3d omega_des, Eigen::Vector3d omegaD_des, Eigen::Matrix3d K_ang, Eigen::Matrix3d K_omg,Eigen::Vector3d* err_int, Eigen::Matrix3d Ki, float time_step, float wind_up_limit_up, float wind_up_limit_low);
...
#endif //ARDUPILOT_AC_ATTITUDECONTROL_SCOBOT_H
