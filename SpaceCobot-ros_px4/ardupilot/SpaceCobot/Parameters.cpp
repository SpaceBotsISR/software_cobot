...
const AP_Param::Info Copter::var_info[] = {
    ...
    //GOBJECT(arming,                 "ARMING_", AP_Arming_Copter), (FILIPE ROSA)
    ...
    // @Units: cm/s/s
    // @User: Advanced
    //GGROUP(pi_vel_xy,   "VEL_XY_",  AC_PI_2D), (FILIPE ROSA)
    ...
    // @Range: 1.000 8.000
    // @User: Standard
    //GGROUP(p_vel_z,     "VEL_Z_", AC_P), (FILIPE ROSA)
    ...
    // @Units: Hz
    // @User: Standard
    //GGROUP(pid_accel_z, "ACCEL_Z_", AC_PID), (FILIPE ROSA)
    ...
    // @Range: 1.000 3.000
    // @User: Standard
    //GGROUP(p_alt_hold,              "POS_Z_", AC_P), (FILIPE ROSA)
    ...
    // @Range: 0.500 2.000
    // @User: Standard
    //GGROUP(p_pos_xy,                "POS_XY_", AC_P), (FILIPE ROSA)

    // variables not in the g class which contain EEPROM saved variables

    // @Group: RELAY_
    // @Path: ../libraries/AP_Relay/AP_Relay.cpp
    //GOBJECT(relay,                  "RELAY_", AP_Relay), (FILIPE ROSA)

    // @Group: LGR_
    // @Path: ../libraries/AP_LandingGear/AP_LandingGear.cpp
    //GOBJECT(landinggear,    "LGR_", AP_LandingGear), (FILIPE ROSA)
    ...
    //GOBJECTPTR(wp_nav, "WPNAV_",       AC_WPNav), (FILIPE ROSA)

    // @Group: CIRCLE_
    // @Path: ../libraries/AC_WPNav/AC_Circle.cpp
    //GOBJECTPTR(circle_nav, "CIRCLE_",  AC_Circle), (FILIPE ROSA)

    // @Group: PSC
    // @Path: ../libraries/AC_AttitudeControl/AC_PosControl.cpp
    //GOBJECTPTR(pos_control, "PSC", AC_PosControl), (FILIPE ROSA)
    ...
    //GOBJECT(rcmap, "RCMAP_",        RCMapper), (FILIPE ROSA)
    ...
    //GOBJECT(mission, "MIS_",       AP_Mission), (FILIPE ROSA)

    // @Group: RSSI_
    // @Path: ../libraries/AP_RSSI/AP_RSSI.cpp
    //GOBJECT(rssi, "RSSI_",  AP_RSSI),  (FILIPE ROSA)
    ...
    //GOBJECT(rpm_sensor, "RPM", AP_RPM), (FILIPE ROSA)

    // @Group: ADSB_
    // @Path: ../libraries/AP_ADSB/AP_ADSB.cpp
    //GOBJECT(adsb,                "ADSB_", AP_ADSB), (FILIPE ROSA)

    // @Group: AVD_
    // @Path: ../libraries/AP_Avoidance/AP_Avoidance.cpp
    //GOBJECT(avoidance_adsb, "AVD_", AP_Avoidance_Copter), (FILIPE ROSA)
    ...
    // @Bitmask: 0:Roll,1:Pitch,2:Yaw
    // @User: Standard
    //GSCALAR(autotune_axis_bitmask, "AUTOTUNE_AXES", 7),  // AUTOTUNE_AXIS_BITMASK_DEFAULT (FILIPE ROSA)
    ...
    // @Range: 0.05 0.10
    // @User: Standard
    //GSCALAR(autotune_aggressiveness, "AUTOTUNE_AGGR", 0.1f), (FILIPE ROSA)
    ...
    // @Range: 0.001 0.006
    // @User: Standard
    //GSCALAR(autotune_min_d, "AUTOTUNE_MIN_D", 0.001f), (FILIPE ROSA)

    // @Group: NTF_
    // @Path: ../libraries/AP_Notify/AP_Notify.cpp
    //GOBJECT(notify, "NTF_",  AP_Notify), (FILIPE ROSA)
    ...
    // @User: Standard
    //GSCALAR(throw_motor_start, "THROW_MOT_START", 0), (FILIPE ROSA)
    ...
    // @User: Standard
    //GSCALAR(terrain_follow, "TERRAIN_FOLLOW", 0), (FILIPE ROSA)
...
//#endif
    ...
    //AP_SUBGROUPINFO(beacon, "BCN", 14, ParametersG2, AP_Beacon), (Filipe Rosa)
