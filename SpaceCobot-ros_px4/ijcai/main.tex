...
of a space station. These are microgravity environments with
...
\begin{figure*}
  \def\gscale{0.28}
  \centering
  \subfloat[]{\includegraphics[height=\gscale\linewidth]{figs/side_view.png}}
  \hfil
  \subfloat[]{\includegraphics[height=\gscale\linewidth]{figs/per_render_labeled.pdf}}
...
%   \subfloat[]{\vbox{%
%       \def\gw{0.2}
%       \hbox{\fbox{\includegraphics[width=\gw\linewidth]{figs/instace-1.png}}}
%       \hbox{\fbox{\includegraphics[width=\gw\linewidth]{figs/instace-2.png}}}
%       \hbox{\fbox{\includegraphics[width=\gw\linewidth]{figs/instace-3.png}}}
%       \hbox{\fbox{\includegraphics[width=\gw\linewidth]{figs/instace-4.png}}}
%     }}
%   \hfil
%   \subfloat[]{\includegraphics[height=\gs\linewidth, clip=true,
...
\begin{figure}
  ...
  \subfloat[hit with a table]{%
    \includegraphics[width=0.4\linewidth]{figs/astri_table.pdf}}
  \qquad
  \subfloat[hit with a wall]{%
    \includegraphics[width=0.5\linewidth]{figs/astri_wall.pdf}}
...
\begin{figure}
  \centering
  \subfloat[hit with a table]{%
    \includegraphics[width=\linewidth]{figs/plot_table.pdf}} \\
  \subfloat[hit with a wall]{%
    \includegraphics[width=\linewidth]{figs/plot_wall.pdf}}
