...
///
/// DO NOT EDIT THIS INCLUDE - if you want to make a local change, make that
/// change in your local copy of SCobot_Config.h.
///
#include "SCobot_Config.h"
...
# define MAIN_LOOP_SECONDS 0.0050f
# define MAIN_LOOP_MICROS  5000
*/


// run at 100Hz on all systems
# define MAIN_LOOP_RATE    100
# define MAIN_LOOP_SECONDS 0.0100f
